...
public class ItemCompanyPrice implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof com.bankmisr.warehouse.entity.ItemCompanyPrice)) {
            return false;
        }
        com.bankmisr.warehouse.entity.ItemCompanyPrice other = (com.bankmisr.warehouse.entity.ItemCompanyPrice) object;
