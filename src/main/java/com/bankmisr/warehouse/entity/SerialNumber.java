 ...
 */
@Entity
@Table(name = "serial_number", catalog = "warehouse", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "SerialNumber.findAll", query = "SELECT s FROM SerialNumber s"),
    @NamedQuery(name = "SerialNumber.findById", query = "SELECT s FROM SerialNumber s WHERE s.id = :id"),
...
public class SerialNumber implements Serializable {
    ...
    public String toString() {
        return "Entity.SerialNumber[ id=" + id + " ]";
    }
