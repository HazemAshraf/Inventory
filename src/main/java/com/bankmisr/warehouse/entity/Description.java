 ...
 */
@Entity
@Table(name = "description", catalog = "warehouse", schema = "")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "Description.findByName", query = "SELECT d FROM Description d WHERE d.name = :name")})
public class Description implements Serializable {
    ...
    public String toString() {
        return "Entity.Description[ id=" + id + " ]";
    }
