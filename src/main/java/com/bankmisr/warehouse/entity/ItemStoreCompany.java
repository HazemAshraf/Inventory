...
@Table(name = "item_store_company", catalog = "pharmacy", schema = "")
 public class ItemStoreCompany implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof com.bankmisr.warehouse.entity.ItemStoreCompany)) {
            return false;
        }
        com.bankmisr.warehouse.entity.ItemStoreCompany other = (com.bankmisr.warehouse.entity.ItemStoreCompany) object;
